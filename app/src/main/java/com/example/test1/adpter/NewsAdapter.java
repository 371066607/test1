...
//    private JSONArray jsonArray;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       ...
       if (viewType == 1){
           ...
           return new ViewHolerThree(view);
       }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (type==1){
            ViewHolerOne vh = (ViewHolerOne) holder;
            ...
            Picasso.get()
                    .load(newsEntity.getNewsThumbs().get(0).getThumbUrl())
                    .into(vh.thumb);
        }else if (type==2){
            ViewHolerTwo vh = (ViewHolerTwo) holder;
            vh.title.setText(newsEntity.getNewsTitle());
            vh.author.setText(newsEntity.getAuthorName());
            vh.comment.setText(newsEntity.getCommentCount() + "评论 .");
            vh.time.setText(newsEntity.getReleaseDate());
            ...
            Picasso.get()
                    ...
                    .into(vh.pic1);
            Picasso.get()
                    .load(newsEntity.getNewsThumbs().get(1).getThumbUrl())
                    .into(vh.pic2);
            Picasso.get()
                    .load(newsEntity.getNewsThumbs().get(2).getThumbUrl())
                    .into(vh.pic3);
        }else {
            ViewHolerThree vh = (ViewHolerThree) holder;
            vh.title.setText(newsEntity.getNewsTitle());
            vh.author.setText(newsEntity.getAuthorName());
            vh.comment.setText(newsEntity.getCommentCount() + "评论 .");
            vh.time.setText(newsEntity.getReleaseDate());
    ...
    public class ViewHolerOne extends RecyclerView.ViewHolder{
        ...
        public ViewHolerOne(@NonNull View view) {
            super(view);
    ...
    public class ViewHolerTwo extends RecyclerView.ViewHolder{
        private TextView title;
        private TextView author;
        private TextView comment;
        private TextView time;
        ...
        public ViewHolerTwo(@NonNull View view) {
            super(view);
            title = view.findViewById(R.id.title);
            author = view.findViewById(R.id.author);
            comment = view.findViewById(R.id.comment);
    ...
    public class ViewHolerThree extends RecyclerView.ViewHolder{
        private TextView title;
        private TextView author;
        private TextView comment;
        private TextView time;
        ...
        public ViewHolerThree(@NonNull View view) {
            super(view);
            title = view.findViewById(R.id.title);
            author = view.findViewById(R.id.author);
            comment = view.findViewById(R.id.comment);
